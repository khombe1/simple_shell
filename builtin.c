 ...
 * @s: string supposed to be converted
 * Return: 0 when there are no numbers in string, converted number otherwise
 *       -1 on error
 */
int _erratoi(char *s)
{
...
/**
 * remove_comments - takes the place of first instance of '#' with '\0'
 * @buf: modifiable address of string
 *
 * Return: Always 0;
 */
